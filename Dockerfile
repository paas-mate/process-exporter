...
tar -xf process-exporter-$version.linux-$TARGETARCH.tar.gz -C /opt/process_exporter --strip-components 1 && \
rm -rf process-exporter-$version.linux-$TARGETARCH.tar.gz
